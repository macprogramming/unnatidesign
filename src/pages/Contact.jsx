        ...
        <>
            <div className="row px-md-5" id="Styles">
                <div className="col-12 text-center">
                    <h3 className="m-0 playfair-display fw-bold">Get In Touch</h3>
                </div>
            </div>
            <div className="row">
                <div className="col-6 px-5">
                    ...
                    <ol className="list-group list-unstyled">
                        <li className="list-group-item d-flex justify-content-between align-items-start">
                            ...
                            <div className="fw-bold">Our Studio</div>
                            <small>42 Embroidery Lane, Handcraft Distinct, Mumbai, India 400001</small>
                            </div>
                        ...
                        <li className="list-group-item d-flex justify-content-between align-items-start">
                            ...
                            <p className="m-0">Monday to Saturday: 10 AM - </p>
                            <p>sunday closed</p>
                            </div>
                            <span className="badge bg-primary rounded-pill">14</span>
                        </li>
                        ...
                        <div className="card-body">
                            <form className="row g-3 needs-validation" novalidate>
                                ...
                                <div className="col-md-12">
                                    <label for="validationCustomUsername" className="form-label">Subject</label>
                                ...
                                <div className="col-12">
                                    <button className="btn w-100 btn_custom_secondary" type="submit">Send Message</button>
                                </div>
                            </form>
                        </div>
                    </div>
